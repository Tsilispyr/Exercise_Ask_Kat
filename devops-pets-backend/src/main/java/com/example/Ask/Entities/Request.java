...
public class Request {
    ...
    public int getShelterApproved() {
        return ShelterApproved;
    }

    public void setShelterApproved(int shelterApproved) {
        ShelterApproved = shelterApproved;
    }
